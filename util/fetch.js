(async () => {
    ...
    const TOKEN = "43366|q1SZOW1ULa4lgmYJ2ZcMrxUWLoXVOGysRmdLDUhY8a0dac63";
    ...
    // Descarga el archivo final - cambia el nombre del archivo aquí si quieres otro
    const blob = new Blob([JSON.stringify(resultado, null, 2)], { type: "application/json" });
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url;
    a.download = "horarios_2026-2.json"; // <<< nombre del archivo descargado, cámbialo si quieres
